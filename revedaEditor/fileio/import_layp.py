...
from revedaEditor.backend.data_definitions import LayLayer
from revedaEditor.gui.stipple_editor import StippleEditor
...
def parseLyp(lypFile: str, outputFileDir: str) -> bool:
    ...
    try:
        ...
        with outputFileDirObj.joinpath("layoutLayers.py").open("w",
                                                               encoding="utf-8") as file:
            # Write header
            file.write("# Auto-generated layoutLayers.py from LYP file\n")
            file.write("# Do not edit this file manually\n\n")
            file.write("import revedaEditor.backend.data_definitions as ddef\n\n")
            ...
            for i, layerItem in enumerate(root.iterfind("properties")):
                try:
                    ...
                    # Parse colors
                    pcolor = safe_get_color(safe_get_text(frame_color_elem),
                                            QColor(Qt.black))
                    bcolor = safe_get_color(safe_get_text(fill_color_elem),
